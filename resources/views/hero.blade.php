    ...
    <section class="container mx-auto px-4 ">
        <div class=" flex flex-wrap mx-auto md:flex-nowrap gap-1 h-full mt-10">
            ...
            <div class="w-full flex gap-1 md:w-1/2">
                <div
                    class="bg-no-repeat bg-center bg-cover md:hidden mx-auto w-[400px] h-[300px] md:w-[300px] md:h-[608px] bg-slate-500 rounded-xl overflow-hidden">
                </div>
                <div class=" grid-cols-2 grid-flow-row gap-4 w-full hidden md:grid">

                    <div class="row-span-2">
                        <div
                            class="bg-no-repeat bg-center bg-cover hidden mx-auto w-[400px] h-[300px] md:w-full md:h-[416px] md:inline-block bg-slate-500 rounded-xl overflow-hidden">
                        </div>
                    </div>
                    <div>
                        <div
                            class="bg-no-repeat bg-center bg-cover	hidden mx-auto w-[400px] h-[300px] md:w-full  md:max-h-[200px] md:inline-block bg-slate-500 rounded-xl overflow-hidden">
                        </div>
                    </div>
                    <!-- ... -->
                    <div>
