...
@section('content')
    <div class="grid grid-cols-2 gap-3 mx-auto p-4 max-w-7xl mt-6">
        <div class="row-span-2 max-h-[50vh]">
            <img src="/storage/gambar/kos1.jpeg" class="w-full h-full object-cover rounded-3xl shadow-lg" alt="...">
        </div>
    ...
    <div class="container mx-auto mt-8 px-4 w-full">
        <div class="flex  md:flex-row w-full">
            <div class="md:w-2/3 flex flex-col justify-center w-1/2">
                <p class="text-3xl font-semibold text-gray-500 situration">Kamar Mawar</p>
            </div>
            <div class="md:w-1/3 flex mt-4 md:mt-0  justify-center align-middle content-center w-1/2">
                <p class="text-3xl font-semibold text-gray-400">1.500.000 / month</p>
            </div>
        </div>
    </div>
    ...
    <div class="container mx-auto mt-8 px-4">
        <div class="flex flex-col md:flex-row">
            <div class="md:w-2/3 flex flex-col ">
                <p class="">Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim in illum incidunt cupiditate
                    praesentium maxime! Architecto, corporis. Dicta, iure saepe sed debitis corrupti odit, neque, commodi
                    eos iusto id totam quibusdam laborum. Minima totam provident ducimus non minus ex, sapiente repellat
                    sunt quis doloremque voluptate deleniti asperiores quibusdam quos amet!</p>
            </div>
    ...
    <br>
    <div class="grid grid-cols-5 gap-2 mx-auto p-2 max-w-xs">
        <div class="col-span-1">
            <img src="/storage/gambar/kos1.jpeg" class="w-full h-full object-cover rounded-lg" alt="...">
        </div>
        <div class="col-span-1">
            <img src="/storage/gambar/kos1.jpeg" class="w-full h-full object-cover rounded-lg" alt="...">
        </div>
