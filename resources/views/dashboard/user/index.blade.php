...
@section('container')
    ...
    <section class="container mx-6 my-4">
        <a href="/dashboard/locations/create" class="px-4 py-2 bg-sky-500 rounded-full text-white">Add Admin Account</a>
    </section>
                                ...
                                @foreach ($users as $user)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-neutral-700">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="/dashboard/places/{{ $user->id }}"
                                            ...
                                            <a href="/dashboard/places/{{ $user['id'] }}/edit"
                                            ...
                                            <form action="/dashboard/places/{{ $user->id }}" method="post"
                                                class="inline-flex">
                                                @method('delete')
                                                @csrf
                                                <button type="submit"
