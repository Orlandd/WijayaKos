...
@section('container')
    ...
    <section class="container ">
        <h3 class="text-3xl font-bold m-6">Kost</h3>
    </section>
                                ...
                                @foreach ($dorms as $dorm)
                                    <tr class="hover:bg-gray-100 align-top dark:hover:bg-neutral-700">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="/dashboard/dorms/{{ $dorm->id }}"
                                            ...
                                            <a href="/dashboard/dorms/{{ $dorm->id }}/edit"
                                            ...
                                            <form action="/dashboard/dorms/{{ $dorm->id }}" method="post"
                                                class="inline-flex">
                                                @method('delete')
                                                @csrf
