...
@section('container')
    ...
    <section class="container px-3">
        ...
        <div class="rounded-xl overflow-hidden">
            <img src="{{ asset('storage/booking/' . $booking->bukti) }}" alt="Proof of Payment" class=" w-full object-cover">
        </div>
