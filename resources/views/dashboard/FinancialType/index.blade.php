...
@section('container')
    ...
    <section class="container ">
        <h3 class="text-3xl font-bold m-6">Financial Type</h3>
    </section>
    ...
    <section class="container mx-6 my-4">
        <a href="/dashboard/financial-types/create" class="px-4 py-2 bg-sky-500 rounded-full text-white">New Type</a>
    </section>
                                ...
                                @foreach ($types as $type)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-neutral-700">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                            ...
                                            <a href="/dashboard/events/{{ $type['id'] }}/edit"
                                            ...
                                            <form action="/dashboard/events/{{ $type['id'] }}" method="post"
                                                class="inline-flex">
                                                @method('delete')
                                                @csrf
                                                <button type="submit"
                                                    onclick="return confirm('Are you sure delete {{ $type->name }}?')"
