...
@section('container')
    ...
    <section class="container ">
        <h3 class="text-3xl font-bold m-6">Income Report</h3>
    </section>
    ...
    <section class="container mx-6 my-4">
        ...
        <div class="hs-dropdown relative inline-flex">
            ...
            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-60 bg-white shadow-md rounded-lg p-2 mt-2 dark:bg-neutral-800 dark:border dark:border-neutral-700 dark:divide-neutral-700 after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 before:absolute before:-top-4 before:start-0 before:w-full"
                ...
                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"
                    @if (request('year')) href="/dashboard/income?month=01&year={{ request('year') }}"
                @else href="/dashboard/income?month=01" @endif>
                    January
                </a>
                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"
                    @if (request('year')) href="/dashboard/income?month=02&year={{ request('year') }}"
                @else href="/dashboard/income?month=02" @endif>
                    February
                </a>
                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"
                    @if (request('year')) href="/dashboard/income?month=03&year={{ request('year') }}"
                @else href="/dashboard/income?month=03" @endif>
                    March
                </a>
                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"
                    @if (request('year')) href="/dashboard/income?month=04&year={{ request('year') }}"
                @else href="/dashboard/income?month=04" @endif>
                    April
                </a>
                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"
                    @if (request('year')) href="/dashboard/income?month=05&year={{ request('year') }}"
                @else href="/dashboard/income?month=05" @endif>
                    May
                </a>
                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"
                    @if (request('year')) href="/dashboard/income?month=06&year={{ request('year') }}"
                @else href="/dashboard/income?month=06" @endif>
                    June
                </a>
                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"
                    @if (request('year')) href="/dashboard/income?month=07&year={{ request('year') }}"
                @else href="/dashboard/income?month=07" @endif>
                    July
                </a>
                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"
                    @if (request('year')) href="/dashboard/income?month=08&year={{ request('year') }}"
                @else href="/dashboard/income?month=08" @endif>
                    August
                </a>
                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"
                    @if (request('year')) href="/dashboard/income?month=09&year={{ request('year') }}"
                @else href="/dashboard/income?month=09" @endif>
                    September
                </a>
                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"
                    @if (request('year')) href="/dashboard/income?month=10&year={{ request('year') }}"
                @else href="/dashboard/income?month=10" @endif>
                    October
                </a>
                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"
                    @if (request('year')) href="/dashboard/income?month=11&year={{ request('year') }}"
                @else href="/dashboard/income?month=11" @endif>
                    November
                </a>
                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"
                    @if (request('year')) href="/dashboard/income?month=12&year={{ request('year') }}"
                @else href="/dashboard/income?month=12" @endif>
                    December
                </a>
            ...
            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-60 bg-white shadow-md rounded-lg p-2 mt-2 dark:bg-neutral-800 dark:border dark:border-neutral-700 dark:divide-neutral-700 after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 before:absolute before:-top-4 before:start-0 before:w-full"
                ...
                @if ($finances != null && count($finances) > 0)
                    ...
                    @for ($year = $startYear; $year <= $currentYear; $year++)
                        <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"
                            @if (request('month')) href="/dashboard/income?year={{ $year }}&month={{ request('month') }}"
                @else href="/dashboard/income?year={{ $year }}" @endif>
                            {{ $year }}
                        </a>
                    @endfor
                @endif
